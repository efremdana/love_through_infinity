...
define config.name = _("Любовь через бесконечность")
...
define build.name = "love_through_infinity"
...
define config.save_directory = "Testing-1760265443"
