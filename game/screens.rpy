...
style logpanel_frame:
    background "#000000AA"
    padding (20, 20, 20, 20)
    outlines [(2, "#00AFFF", 0, 0)]

style logpanel_title:
    color "#00AFFF"
    size 32
    xalign 0.0

style logpanel_text:
    xalign 0.0          # выравнивание виджета внутри контейнера по умолчанию
    text_align 0.0      # выравнивание строк внутри текстового блока (0.0 = left)
    color "#00FFAA"
    font "fonts/RobotoMono.ttf"
    size 22

# Стиль кнопки закрытия
style logpanel_close:
    background "#002233CC"         # тёмно-красный полупрозрачный фон
    hover_background "#66E0FF"
    color "#FFFFFF"                # БЕЛЫЙ текст (а не foreground!)
    hover_color "#dbdaff"          # светлее при наведении
    padding (6, 6, 6, 6)
    size 32
    bold True
    xalign 1.0
...
## Панели
screen ship_logs(log_text):

    modal True                      # блокирует остальной текст/взаимодействие
    frame:
        style_prefix "logpanel"
        xalign 0.5
        yalign 0.5
        xsize 1500
        ysize 600
        ...
        vbox:
            ...
            hbox:
                ...
                label "Технические логи корабля" style "logpanel_title"

                # Если вы вызываете экран через 'call screen', используйте Return().
                # Если через 'show screen', используйте Hide("ship_logs").
                textbutton "✕" action Return() style "logpanel_close"
            ...
            viewport:
                ...
                vbox:
                    ...
                    text log_text:
                        style "logpanel_text"
                        xalign 0.0      # положение виджета
                        text_align 0.0  # положение строк внутри текста
